...
namespace Planova.Persistence.Migrations
{
    ...
    [Migration("20260613174352_AddProjectCodeToXerImportSession")]
    partial class AddProjectCodeToXerImportSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planova.Cost.Domain.Entities.ActualCost", b =>
                {
                    ...
                    b.Property<Guid?>("DeletedActivityId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Planova.Cost.Domain.Entities.Budget", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("DirectCostTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("IsManualOverride")
                        .HasColumnType("INTEGER");

                    b.Property<decimal?>("ManualTotalBudget")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("ProjectId")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("ResourceCostTotal")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Planova.Cost.Domain.Entities.CostBaseline", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CostBaselines", (string)null);
                });

            modelBuilder.Entity("Planova.Cost.Domain.Entities.CostBaselineRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CostBaselineRows", (string)null);
                });

            modelBuilder.Entity("Planova.Cost.Domain.Entities.DirectCost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Planova.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Planova.Domain.Entities.Contractor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Planova.Domain.Entities.ProjectDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<double>("RemainingDuration")
                        .HasColumnType("REAL");
                    ...
                    b.ToTable("PrimaveraActivities", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraBaseline", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ProjectId", "BaselineId", "VersionNumber");

                    b.ToTable("PrimaveraBaselines", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraCalendar", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");

                    b.Property<string>("BaseCalendarId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("IsBaseCalendar")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PrimaveraCalendars", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ParentCodeId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PrimaveraCodes", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraProject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PrimaveraProjects", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<double>("LagDuration")
                        .HasColumnType("REAL");

                    b.Property<string>("PredTaskId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PrimaveraRelationships", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraRepairAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("TargetEntityIds")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PrimaveraRepairActions", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraResourceAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");

                    b.Property<double>("ActualUnits")
                        .HasColumnType("REAL");
                    ...
                    b.ToTable("PrimaveraResourceAssignments", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraUdf", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PrimaveraUdfs", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraValidationIssue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PrimaveraValidationIssues", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.PrimaveraValidationRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PrimaveraValidationRules", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.XerExportProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("IncludeRawTables")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("OutputPathTemplate")
                        .HasColumnType("TEXT");

                    b.Property<string>("SelectedEntityTypes")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.ToTable("XerExportProfiles", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.XerImportSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("XerImportSessions", (string)null);
                });

            modelBuilder.Entity("Planova.Primavera.Domain.Entities.XerRawTable", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("XerRawTables", (string)null);
                });
            ...
            modelBuilder.Entity("Planova.Cost.Domain.Entities.CostBaselineRow", b =>
                {
                    b.HasOne("Planova.Cost.Domain.Entities.CostBaseline", "Baseline")
                        .WithMany("Rows")
            ...
            modelBuilder.Entity("Planova.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasOne("Planova.Domain.Entities.Subcontractor", "Subcontractor")
                        .WithMany("Projects")
